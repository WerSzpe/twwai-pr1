...
export function Dashboard() {
    ...
    const getDataOnDate = async (date) => {
        const res = await fetch("https://twwai-33205.herokuapp.com/api/params/search/"+date)
        const dataRes = await res.json();
    ...
    useEffect(()=>{
        const socket = io("https://twwai-33205.herokuapp.com", {
        ...
        const fetchAir = async () => {
            ...
            const currentRes = await fetch("https://twwai-33205.herokuapp.com/api/params/last")
    ...
    return(
        <div style={styles}>
            <div className='col-3'>
                ...
                <MyCalendar getData={getDataOnDate} doOnClick={getAllData}/>
            </div>
            <div className='col-9'>
